...
class tx_lumogooglemaps_pi1_wizicon {
	...
	function proc($wizardItems)	{
		...
		$wizardItems['plugins_tx_lumogooglemaps_pi1'] = array(
			'icon' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('lumogooglemaps') . 'pi1/ce_wiz.gif',
	...
	function includeLocalLang()	{
		$llFile = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('lumogooglemaps') . 'locallang.xml';
